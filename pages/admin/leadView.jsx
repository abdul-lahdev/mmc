...
export default function LeadView() {
  ...
  return (
    <>
      ...
      {/* Match Finder Modal start */}
      <div>
        <Transition show={matchFinderOpen} as={Fragment}>
          <Dialog as="div" className="relative z-10" onClose={setMatchFinderOpen}>
            <Transition.Child
              as={Fragment}
              enter="ease-out duration-300"
              enterFrom="opacity-0"
            ...
            <div className="fixed inset-0 z-10 w-screen overflow-y-auto">
              <div className="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
                <Transition.Child
                  ...
                  leaveTo="opacity-0 translate-y-4 sm:translate-y-0 sm:scale-95"
                >
                  <DialogPanel className="relative transform overflow-hidden rounded-[12px] bg-white text-left shadow-xl transition-all sm:my-8 w-full max-w-[50%]">
                    <div
                      className="bg-white overflow-y-auto"
                      style={{ scrollbarWidth: "none" }}
                    >
                      <div className="px-4 py-4 flex gap-3 items-center border-b border-[#F1F5F9]">
                        <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg"> <rect x="0.5" y="0.5" width="39" height="39" rx="19.5" fill="#F1F5F9" /> <rect x="0.5" y="0.5" width="39" height="39" rx="19.5" stroke="#CAD5E2" /> <path d="M15.8333 17.0833H20M15.8333 20H22.5M15.8333 25V26.9463C15.8333 27.3903 15.8333 27.6123 15.9244 27.7263C16.0035 27.8255 16.1236 27.8832 16.2504 27.8831C16.3964 27.8829 16.5697 27.7442 16.9165 27.4668L18.9043 25.8765C19.3104 25.5517 19.5135 25.3892 19.7396 25.2737C19.9402 25.1712 20.1537 25.0963 20.3743 25.051C20.6231 25 20.8831 25 21.4031 25H23.5C24.9001 25 25.6002 25 26.135 24.7275C26.6054 24.4878 26.9878 24.1054 27.2275 23.635C27.5 23.1002 27.5 22.4001 27.5 21V16.5C27.5 15.0999 27.5 14.3998 27.2275 13.865C26.9878 13.3946 26.6054 13.0122 26.135 12.7725C25.6002 12.5 24.9001 12.5 23.5 12.5H16.5C15.0999 12.5 14.3998 12.5 13.865 12.7725C13.3946 13.0122 13.0122 13.3946 12.7725 13.865C12.5 14.3998 12.5 15.0999 12.5 16.5V21.6667C12.5 22.4416 12.5 22.8291 12.5852 23.147C12.8164 24.0098 13.4902 24.6836 14.353 24.9148C14.6709 25 15.0584 25 15.8333 25Z" stroke="#90A1B9" strokeWidth="1.5" stroke-linecap="round" strokeLinejoin="round" /> </svg>
                        <h1 className="text-[16px] text-[#0F172B] font-[700]">Match Funder </h1>
                      </div>

                      <div className="px-4">
                        <p className="mt-3 text-[#45556C] text-[14px] font-[400]">Select relevant funders and proceed to share the merchant's offer for further evaluation.</p>
                        <MatchFunder />
                      </div>
        ...
        <div className="flex items-center gap-3 justify-end">
          <div>
            <Tooltip text="Fint Match Finder" position="bottom">
              <button onClick={() => setMatchFinderOpen(true)} className="h-[38px] flex items-center gap-2 bg-[#2B7FFF] border border-[#8EC5FF] rounded-[60px] text-[#fff] text-[12px] font-[700] leading-5 px-4 py-3 text-center cursor-pointer select-none hover:bg-[#2873e6] ">
                <span>
                  <svg
                    width="16"
                    height="16"
                        ...
                        <Tooltip text="Phone Call" position="top">
                          <div className="hover:bg-[#e2e6ea] rounded-[50%] flex items-center justify-center w-[28px] h-[28px] opacity-0 group-hover:opacity-100 transition duration-300 cursor-pointer">
                            ...
                            >
                              ...
                              >
                                {" "}
                                <g clipPath="url(#clip0_680_11727)">
                                  {" "}
                                  <path
                                    d="M9.36709 4.00016C10.0182 4.12721 10.6167 4.44567 11.0858 4.91479C11.5549 5.38391 11.8734 5.98234 12.0004 6.6335M9.36709 1.3335C10.7199 1.48379 11.9815 2.08961 12.9446 3.0515C13.9077 4.01339 14.5151 5.27417 14.6671 6.62683M6.81841 9.24221C6.01736 8.44116 5.38483 7.5354 4.92084 6.56898C4.88092 6.48586 4.86097 6.44429 4.84564 6.3917C4.79115 6.2048 4.83029 5.97529 4.94363 5.817C4.97552 5.77246 5.01363 5.73436 5.08984 5.65815C5.32291 5.42508 5.43944 5.30854 5.51563 5.19136C5.80296 4.74943 5.80296 4.17971 5.51563 3.73778C5.43944 3.6206 5.32291 3.50406 5.08984 3.27099L4.95992 3.14108C4.60563 2.78678 4.42848 2.60964 4.23823 2.51341C3.85985 2.32203 3.41301 2.32203 3.03464 2.51341C2.84438 2.60964 2.66723 2.78678 2.31294 3.14108L2.20785 3.24617C1.85477 3.59925 1.67823 3.77579 1.54339 4.01581C1.39378 4.28215 1.28621 4.69581 1.28712 5.00129C1.28793 5.27659 1.34134 5.46474 1.44814 5.84104C2.02212 7.8633 3.1051 9.77154 4.69709 11.3635C6.28908 12.9555 8.19732 14.0385 10.2196 14.6125C10.5959 14.7193 10.784 14.7727 11.0593 14.7735C11.3648 14.7744 11.7785 14.6668 12.0448 14.5172C12.2848 14.3824 12.4614 14.2059 12.8145 13.8528L12.9195 13.7477C13.2738 13.3934 13.451 13.2162 13.5472 13.026C13.7386 12.6476 13.7386 12.2008 13.5472 11.8224C13.451 11.6321 13.2738 11.455 12.9195 11.1007L12.7896 10.9708C12.5566 10.7377 12.44 10.6212 12.3228 10.545C11.8809 10.2577 11.3112 10.2577 10.8693 10.545C10.7521 10.6212 10.6355 10.7377 10.4025 10.9708C10.3263 11.047 10.2882 11.0851 10.2436 11.117C10.0853 11.2303 9.85582 11.2695 9.66892 11.215C9.61633 11.1997 9.57476 11.1797 9.49164 11.1398C8.52523 10.6758 7.61946 10.0433 6.81841 9.24221Z"
                                    stroke="#62748E"
