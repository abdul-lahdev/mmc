...
export default function Carriers() {
  ...
  const [CarrierModalAnimation, setCarrierModalAnimation] = useState(false);
  ...
  return (
                ...
                <div className="bg-white dark:bg-gray-800  py-3  sm:flex sm:flex-row-reverse border-t dark:border-gray-600  mt-3">
                  <button
                    ...
                    onClick={() => {
                      ...
                      setCarrierModalAnimation(false);
                    }}
                  >
                    Submit
                  </button>
        ...
        <div className="flex justify-between items-center flex-wrap">
          <div>
            ...
            <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">
              Your all imported or generated Carriers here
            </p>
          </div>
          <div className="flex gap-2 mt-2 md:mt-0">
            ...
            <button
              ...
              onClick={() => {
                ...
                setTimeout(() => setCarrierModalAnimation(true), 10);
              }}
            ...
            >
              ...
              <span className="text-sm ml-2 hidden md:block">Add Carrier</span>
            </button>
          </div>
        </div>
      </div>
    ...
    <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm p-4 ">
      <p className="text-sm text-gray-500 dark:text-gray-400 mb-1">Total Carriers</p>
